...
public enum LogEvents
{
    ...
    [Description("Consul KV key '{StorageName:string}' loaded {KeyCount:int} key(s). Configuration (sensitive values redacted): {ConfigData:string}.")]
    [HttpStatusCode(200)]
    ...
    [Description("Content moderation job enqueued for entry '{EntryId:Guid}' with {ImageCount:int} image(s).")]
    [HttpStatusCode(200)]
    ContentModerationJobEnqueued = 12402,
    [Description("Unexpected error while processing content moderation batch. Details: '{ErrorMessage:string?}'.")]
    [HttpStatusCode(500)]
    ContentModerationWorkerBatchError = 12403,
    [Description("Giving up on moderating entry '{EntryId:Guid}' after {FailureCount:int} attempts.")]
    [HttpStatusCode(500)]
    ContentModerationJobAbandoned = 12404,
    [Description("Content moderation provider returned an error for entry '{EntryId:Guid}'. Details: '{ErrorMessage:string}'.")]
    [HttpStatusCode(500)]
    ContentModerationProviderError = 12405,
    ...
    [Description("Text content of entry '{EntryId:Guid}' was flagged by the content moderation provider.")]
    [HttpStatusCode(200)]
    TextContentFlagged = 20316,
    ...
    [Description("Image '{ImageId:Guid}' of entry '{EntryId:Guid}' was flagged by the content moderation provider.")]
    [HttpStatusCode(200)]
    ImageContentFlagged = 20408,
