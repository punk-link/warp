...
public enum LogEvents
{
    ...
    [Description("The entry plain text content size exceeded the allowed limit.")]
    [HttpStatusCode(400)]
    EntryPlainTextSizeExceeded = 20311,
    [Description("The entry HTML content size exceeded the allowed limit.")]
    [HttpStatusCode(400)]
    EntryHtmlSizeExceeded = 20312,
    [Description("The entry ContentDelta is required for Advanced mode entries.")]
    [HttpStatusCode(400)]
    EntryContentDeltaRequired = 20313,
    [Description("The entry ContentDelta must be valid JSON.")]
    [HttpStatusCode(400)]
    EntryContentDeltaInvalidJson = 20314,
    [Description("The entry ContentDelta size exceeded the allowed limit.")]
    [HttpStatusCode(400)]
    ...
    [Description("One or more images failed a malware scan and could not be deleted. The entry was not created.")]
    [HttpStatusCode(500)]
