/// <auto-generated/>
// Generated on: 2026-03-16 21:57:05 UTC
...
internal static partial class LogMessages
{
    ...
    [LoggerMessage((int)LogEvents.VaultTokenFileNotFound, LogLevel.Warning, "Vault token file '{TokenFile:string}' was not found; set PNKL_VAULT_TOKEN manually.")]
    public static partial void LogVaultTokenFileNotFound(this ILogger logger, string tokenFile);

    [LoggerMessage((int)LogEvents.VaultTokenFileIsEmpty, LogLevel.Warning, "Vault token file '{TokenFile:string}' is empty; set PNKL_VAULT_TOKEN manually.")]
    public static partial void LogVaultTokenFileIsEmpty(this ILogger logger, string tokenFile);

    [LoggerMessage((int)LogEvents.VaultTokenLoadedFromFile, LogLevel.Information, "Vault token successfully loaded from file '{TokenFile:string}'.")]
    ...
    [LoggerMessage((int)LogEvents.ConsulConfigLoaded, LogLevel.Debug, "Consul KV key '{StorageName:string}' loaded {KeyCount:int} key(s). Values: {ConfigData:string}.")]
    ...
    // Domain.Image
    [LoggerMessage((int)LogEvents.MaliciousImageDetected, LogLevel.Warning, "Image '{ImageId:Guid}' was flagged as malicious by GuardDuty and has been excluded from entry '{EntryId:Guid}'.")]
    public static partial void LogMaliciousImageDetected(this ILogger logger, Guid imageId, Guid entryId);

    [LoggerMessage((int)LogEvents.AllImagesMalicious, LogLevel.Warning, "All {ImageCount:int} uploaded images for entry '{EntryId:Guid}' were flagged as malicious by GuardDuty. The entry cannot be created.")]
    public static partial void LogAllImagesMalicious(this ILogger logger, int imageCount, Guid entryId);

    [LoggerMessage((int)LogEvents.MalwareScanTimeout, LogLevel.Warning, "Malware scan for image '{ImageId:Guid}' did not complete within the timeout period. The image will be treated as clean.")]
    public static partial void LogMalwareScanTimeout(this ILogger logger, Guid imageId);

    [LoggerMessage((int)LogEvents.MalwareScanError, LogLevel.Error, "Malware scan for image '{ImageId:Guid}' failed. Details: '{ErrorMessage:string}'.")]
