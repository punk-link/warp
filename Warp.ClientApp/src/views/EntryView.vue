    ...
    <section class="px-3 my-5">
      <div class="flex flex-col items-center justify-around min-h-[75vh]">
        ...
        <article class="w-full md:w-1/2 p-3 rounded-sm mb-10">
          <div class="gallery mb-5 hidden"></div>
          <div class="text-content font-sans-serif text-base"></div>
        </article>

        <!-- Action Buttons -->
        <div class="flex justify-between items-center w-full md:w-1/2 pb-3 sticky bottom-0 bg-transparent">
          <div class="bg-white rounded-sm">
            <button id="show-report-modal-button" data-toggle="modal" data-target="#report-modal" class="btn btn-outline-secondary" title="Report">
          ...
          <div class="bg-white rounded-sm">
            <button id="copy-link-button" class="btn btn-outline-gray" title="Copy link">
      ...
      <div class="p-6">
        ...
        <div class="text-center px-4">
          <p class="font-sans-serif text-lg text-gray-600 mb-4">
            You are about to report this content. Use the feature in case of inappropriate content only. This action restricts access to the content for all viewers. Are you sure?
          </p>
        </div>
      </div>
